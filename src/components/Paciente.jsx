    ...
    return (
        <div className="mx-5 my-10 bg-white shadow-md px-5 py-10 rounded-xl">
            ...
            <div className="flex justify-evenly mt-6">
                <a href="#_" className="px-5 py-2.5 font-medium bg-indigo-600 hover:bg-blue-700  text-white rounded-lg text-base flex justify-center items-center gap-1 w-36"
                ...
                <a href="#_" className="px-5 py-2.5 font-medium bg-red-600 hover:bg-red-700 text-white ounded-lg text-base flex justify-center items-center gap-1 w-36 rounded-md" 
